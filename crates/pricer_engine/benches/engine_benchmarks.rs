//! Criterion benchmarks for pricer_engine Monte Carlo pricing.
//!
//! Benchmarks cover:
...
use pricer_engine::checkpoint::CheckpointStrategy;
use pricer_engine::mc::pricer_checkpoint::{CheckpointPricer, CheckpointPricingConfig};
use pricer_engine::mc::thread_local::{current_thread_index, ParallelWorkspaces};
use pricer_engine::mc::{GbmParams, MonteCarloConfig, MonteCarloPricer, PayoffParams};
use pricer_engine::path_dependent::PathPayoffType;
use pricer_engine::rng::PricerRng;
use rayon::prelude::*;
