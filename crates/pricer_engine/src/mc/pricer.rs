...
///
/// ```rust
/// use pricer_engine::mc::PricingResult;
///
...
impl MonteCarloPricer {
    ...
    ///
    /// ```ignore
    /// use pricer_engine::mc::{MonteCarloPricer, MonteCarloConfig, GbmParams, PayoffParams};
    ...
    ///
    /// ```ignore
    /// use pricer_engine::mc::{MonteCarloPricer, MonteCarloConfig, GbmParams, PayoffParams, Greek};
    /// use pricer_core::market_data::curves::{FlatCurve, YieldCurve};
    ///
    /// let config = MonteCarloConfig::builder()
    ///     .n_paths(10_000)
    ...
    ///
    /// ```rust
    /// use pricer_engine::mc::{MonteCarloPricer, MonteCarloConfig, GbmParams};
