...
//! ## Layer 3 Role
//!
//! pricer_engine serves as the AD (Automatic Differentiation) engine in the 4-layer architecture:
...
//!
//! Without the feature flag, pricer_engine remains fully isolated.
//!
//! ## Usage Example
//!
//! ```rust
//! use pricer_engine::verify::{square, square_gradient};
//!
//! // Function value
...
//!
//! This crate was renamed from `pricer_kernel` to `pricer_engine` in version 0.7.0.
//! For backward compatibility, you can still import the crate as `pricer_kernel`:
//!
//! ```toml
//! # Cargo.toml
//! pricer_kernel = { package = "pricer_engine", version = "0.7" }
//! ```
...
/// Please use `pricer_engine` directly instead of `pricer_kernel`.
///
/// # Migration
///
/// Replace `pricer_kernel` with `pricer_engine` in your imports:
///
/// ```rust,ignore
/// // Before
/// use pricer_engine::mc::MonteCarloPricer;
///
/// // After
/// use pricer_engine::mc::MonteCarloPricer;
/// ```
#[deprecated(
    since = "0.7.0",
    note = "pricer_kernel has been renamed to pricer_engine. Please update your imports."
)]
