...
- [ ] 1. serde Feature Flag の設定
- [ ] 1.1 Cargo.toml に serde feature flag を追加
...
- [ ] 5. DayCountConvention の拡張
- [ ] 5.1 DayCountConvention に name メソッドを追加
  - 各 variant に対応する業界標準名称を返す（"ACT/365", "ACT/360", "30/360"）
  - _Requirements: 3.4_

- [ ] 5.2 DayCountConvention のカスタムシリアライゼーション
...
- [ ] 5.3 Date 型を使用した year fraction 計算
